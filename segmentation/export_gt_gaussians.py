# Export one reference Gaussian PLY for each requested class
...
def _load_gaussians(model_path, loaded_iter):
    # Load the Gaussian model at the requested iteration
...
def export(args):
    """Write transferred reference Gaussians for each class"""
    # Load transferred ground truth labels
    ...
    # Export one PLY for each requested class
